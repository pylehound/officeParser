 ...
 */
import { OfficeParser } from './OfficeParser';
import { OfficeParserConfig, OfficeParserAST, OfficeContentNode, OfficeAttachment, OfficeMetadata, TextFormatting, SupportedFileType, OfficeContentNodeType, OfficeMimeType, SlideMetadata, SheetMetadata, HeadingMetadata, ListMetadata, CellMetadata, ImageMetadata, PageMetadata, ContentMetadata, DocImage, Block, TextBlock, ImageBlock, TableBlock, ChartBlock, ChartData, ChartMetadata, CoordinateData, ParagraphMetadata, TextMetadata, NoteMetadata, CommentBlock, InsertionBlock, DeletionBlock, HeaderBlock, FooterBlock, CommentMetadata, TrackedChangeMetadata, CommentReply } from './types';
declare const parseOffice: typeof OfficeParser.parseOffice;
export { OfficeParser, parseOffice, OfficeParserConfig, OfficeParserAST, OfficeContentNode, OfficeAttachment, OfficeMetadata, TextFormatting, SupportedFileType, OfficeContentNodeType, OfficeMimeType, SlideMetadata, SheetMetadata, HeadingMetadata, ListMetadata, CellMetadata, ImageMetadata, PageMetadata, ContentMetadata, DocImage, Block, TextBlock, ImageBlock, TableBlock, ChartBlock, ChartData, ChartMetadata, CoordinateData, ParagraphMetadata, TextMetadata, NoteMetadata, CommentBlock, InsertionBlock, DeletionBlock, HeaderBlock, FooterBlock, CommentMetadata, TrackedChangeMetadata, CommentReply };
